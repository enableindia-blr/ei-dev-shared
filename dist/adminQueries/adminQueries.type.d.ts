...
export type AdminDataFilterQuery<T> = {
    column: keyof T;
    operator: 'equals' | 'not_equals' | 'contains' | 'not_contains' | 'starts_with' | 'ends_with' | 'greater_than' | 'less_than' | 'greater_or_equal' | 'less_or_equal' | 'before' | 'after' | 'on' | 'is_true' | 'is_false';
    value: any;
};
